...
/**
 * Servlet implementation class AllAdminControlSettings
 */
@WebServlet("/AllAdminControlSettings")
public class AllAdminControlSettings extends HttpServlet {
	private static final long serialVersionUID = 1L;

	private DataBaseOperations dataBaseOperations;

	@Resource(name = "learners_academy")
	...
	public void init() throws ServletException {
		...
		try {
			dataBaseOperations = new DataBaseOperations(datasource);
	 ...
	 */
	public AllAdminControlSettings() {
		super();
	...
	private void studentsList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Student> students = dataBaseOperations.getStudents();
	...
	private void teachersList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// get students from db util
		List<Teacher> teachers = dataBaseOperations.getTeachers();
	...
	private void subjectList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Subject> subjects = dataBaseOperations.getSubjects();
	...
	private void classestList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// get subjects from db util
		List<Class> classes = dataBaseOperations.getClasses();
	...
	private void classStudentsList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// get subjects from db util
		List<Student> students = dataBaseOperations.loadClassStudents(classId);
